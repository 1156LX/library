    ...
    <form action="/user/doReg" method="post" enctype="multipart/form-data">
        <table>
            ...
            <tr>
                ...
                <td>密码：<input class="text" type="password" name="password1" />
                </td>
            </tr>
            <tr>
               
                <td>确认密码：<input class="text" type="password" name="password2" />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td colspan="2"><input id="btn" type="submit" value="注册" />
                </td>
            </tr>
        </table>
    </form>
